<nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
        <div class="text-center d-none d-md-inline">
            <button class="navicon-left btn btn-primary" id="sidebarToggle" type="button">
        ...
        <ul class="navbar-nav flex-nowrap ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-list animated--grow-in">
                        <h6 class="dropdown-header">alerts center</h6><a
                            ...
                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                                       src="{{ asset('backend/img/avatars/avatar4.jpeg') }}">
                            ...
                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                                       src="{{ asset('backend/img/avatars/avatar2.jpeg') }}">
                            ...
                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                                       src="{{ asset('backend/img/avatars/avatar3.jpeg') }}">
                            ...
                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                                       src="{{ asset('backend/img/avatars/avatar5.jpeg') }}">
                                <div class="bg-success status-indicator"></div>
                            </div>
                            <div class="font-weight-bold">
            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                                           aria-expanded="false" data-toggle="dropdown"
                                                           href="#"><span
                            class="d-none d-lg-inline mr-2 text-gray-600 small">Ashraf</span><img
                            class="border rounded-circle img-profile"
                            src="{{ asset('backend/img/avatars/avatar1.jpeg') }}"></a>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <li><a class="dropdown-item" href="{{route('adminSettings')}}">Settings</a></li>
